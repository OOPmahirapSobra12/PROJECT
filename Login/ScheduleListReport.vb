...
Public Class ScheduleListReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Login.ScheduleListReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedScheduleListReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ScheduleListReport = New ScheduleListReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
