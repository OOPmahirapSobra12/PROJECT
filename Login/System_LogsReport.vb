...
Public Class System_LogsReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Login.System_LogsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSystem_LogsReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As System_LogsReport = New System_LogsReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
