...
Public Class feedbackshistory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Login.feedbackshistory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedfeedbackshistory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As feedbackshistory = New feedbackshistory()
        rpt.Site = Me.Site
        Return rpt
    End Function
