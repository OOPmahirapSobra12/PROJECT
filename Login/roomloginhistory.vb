...
Public Class roomloginhistory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Login.roomloginhistory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedroomloginhistory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As roomloginhistory = New roomloginhistory()
        rpt.Site = Me.Site
        Return rpt
    End Function
